...
# from tslearn_cuda.soft_dtw_fast import _soft_dtw, _soft_dtw_grad, \
...
@cuda.jit()
def cdist_dtw(dataset, matrix, mask):
    cum_sum = cuda.local.array(shape=(SH, SH), dtype=numba.float64)
    i, j = cuda.grid(2)
