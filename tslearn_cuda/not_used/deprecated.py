...
if True:  # pragma: no cover
    ...
    from tslearn_cuda.not_used.tslearn.utils import to_time_series_dataset, check_equal_size, \
        to_time_series
    from tslearn_cuda.not_used.tslearn.preprocessing import TimeSeriesResampler
    from tslearn_cuda.not_used.tslearn import dtw_path, SquaredEuclidean, SoftDTW
    from tslearn_cuda.not_used.tslearn import _set_weights
